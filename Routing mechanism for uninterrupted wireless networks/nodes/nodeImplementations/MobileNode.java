...
public class MobileNode extends Node {
	...
	UdgNetworkNode currentAntenna = null; // the antenna ths node is connected to, null if this node is not connected to an antenna
	private int seqIDCounter = 0;

	public UdgNetworkNode getCurrentAntenna() {
	...
	public void handleMessages(Inbox inbox) {
		...
		UdgNetworkNode oldAntenna = currentAntenna;
			...
			if(msg instanceof InviteMessage) {
				...
				if(currentAntenna != null) {
					...
					if(oldDist > newDist) {
						...
						this.currentAntenna = (UdgNetworkNode) inbox.getSender();
